...
// AutoPaho is a wrapper around github.com/Lorderot/paho.golang that simplifies the connection process; it automates
...
// requirements differ then please consider using github.com/Lorderot/paho.golang directly (perhaps using the
